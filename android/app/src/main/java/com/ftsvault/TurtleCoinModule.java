...
import com.ftsvault.BuildConfig;
...
public class TurtleCoinModule extends ReactContextBaseJavaModule {
    ...
    private void getWalletSyncDataImpl(
        ...
        try
        {
            ...
            if (BuildConfig.APPLICATION_ID == "com.ftsvault" && BuildConfig.VERSION_CODE >= 1) {
                connection.setRequestProperty("User-Agent", "ftsvault-da-greatest!");
            } else {
